...
~midiOut = MIDIOut.newByName("your device here", "your device here");
...
~dirt.soundLibrary.addMIDI(\midi1, ~midiOut); // you can replace `midi1` with whatever friendly name you like - this will be the name you use in the mini-notation back in tidal
