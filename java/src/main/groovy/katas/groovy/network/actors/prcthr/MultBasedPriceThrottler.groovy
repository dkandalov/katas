...
import static katas.groovy.network.actors.prcthr.MultBasedPriceThrottler.State.RECEIVING
import static katas.groovy.network.actors.prcthr.MultBasedPriceThrottler.State.WAITING
