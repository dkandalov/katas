package ru.orderbook.v4_golf.app;


import ru.orderbook.v4_golf.iface.*;
...
public abstract class AbstractAppEnvironment implements AppEnvironment {
    ...
    /**
     * Implementation of {@link ru.orderbook.v1.iface.Log} which uses the standard out.
     */
    ...
    /**
     * Sends a stream of orders to {@link ru.orderbook.v1.iface.OrderConsumer}s.
     *
    ...
    /**
     * Invokes {@link ru.orderbook.v1.iface.OrderConsumer#handleEvent(ru.orderbook.v1.iface.Action, ru.orderbook.v1.iface.Order)} for every registered consumer with
