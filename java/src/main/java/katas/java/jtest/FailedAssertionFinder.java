...
public class FailedAssertionFinder {
    public static Optional<String> findFailedLineSourceCode(AssertionError e, String assertionClassName, String assertionMethodName) {
        return findFailurePoint(e, assertionClassName, assertionMethodName).flatMap(FailedAssertionFinder::readLineAt);
    }

    private static Optional<StackTraceElement> findFailurePoint(Throwable t, String className, String methodName) {
