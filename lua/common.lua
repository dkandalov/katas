function to_s(o)
  ...
  elseif type(o) == "number" then
    -- Can't use tostring() here because it doesn't print enough digits
    -- so default string representation of a floating point number might not match its in-memory value
    -- (see https://github.com/lua/lua/blob/3ad33fde8511af0c771edf20e128588ab86b967d/luaconf.h#L495)
    return string.format('%.50g', o)
  else
    return tostring(o)
  end
end
