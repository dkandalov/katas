...
class PascalTriangle1 extends ShouldMatchers {
  @Test def shouldComputeElementsOfPascalsTriangle() {
    pascal(0, -1) should equalTo(0)
    pascal(0, 0) should equalTo(1)
    pascal(0, 1) should equalTo(0)

    pascal(1, 0) should equalTo(1)
    pascal(1, 1) should equalTo(1)

    pascal(2, 0) should equalTo(1)
    pascal(2, 1) should equalTo(2)
    pascal(2, 2) should equalTo(1)

    pascal(3, 0) should equalTo(1)
    pascal(3, 1) should equalTo(3)
    pascal(3, 2) should equalTo(3)
    pascal(3, 3) should equalTo(1)
  }
  ...
  @Test def shouldComputePascalTriangle() {
    // TODO finish
    pascalTriangle(0) should equalTo(List())
    pascalTriangle(1) should equalTo(List(List(1)))
    pascalTriangle(2) should equalTo(List(
      List(1),
      List(1, 1)))
    pascalTriangle(3) should equalTo(List(
      List(1),
      List(1, 1),
      List(1, 2, 1)))
    pascalTriangle(4) should equalTo(List(
      List(1),
      List(1, 1),
      List(1, 2, 1),
      List(1, 3, 3, 1)))
    pascalTriangle(5) should equalTo(List(
      List(1),
      List(1, 1),
      List(1, 2, 1),
      List(1, 3, 3, 1),
