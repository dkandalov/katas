...
class Perm3_ extends ShouldMatchers {
  ...
  @Test def shouldFindPermutationsOfAList() {
    perm(List()) should equalTo(List())
    perm(List(1)) should equalTo(List(List(1)))
    perm(List(1, 2)) should equalTo(List(List(1, 2), List(2, 1)))
    perm(List(1, 2, 3)) should equalTo(List(
      List(1, 2, 3), List(1, 3, 2),
      List(2, 1, 3), List(2, 3, 1),
      List(3, 1, 2), List(3, 2, 1)
    ))
    perm(List(1, 2, 3, 4)) should equalTo(List(
    ...
    perm(List(1, 2, 3, 4, 5)) should equalTo(List(
