...
public class ConnectionsTest {
    public static void pointsAreConnectedToThemselves(Connections connections) {
    ...
    public static void onePointCanBeConnectedToMultiplePoints(Connections connections) {
    ...
    public static void isConnectedMethodShouldNotHaveInfiniteLoops(Connections connections) {
        connections.connect(0, 1);
    ...
    public static void connectionsAreTransitive(Connections connections) {
        connections.connect(0, 1);
    ...
    public static void pointsCanBeNotConnected(Connections connections){
        connections.connect(0, 1);
    ...
    public static void quickUnion_ForBigInput(Connections connections) {
        connections.
                connect(3, 4).
                connect(4, 9).
                connect(8, 0).
