...
public interface StringUtil {
	...
	/**
	 * @param input a string. Not null.
	 * @return character(s) that occurs most frequently in the input string. If several characters have the same
	 *         frequency, they are all added to string (order is not specified).
	 */
