describe("Binary Search Tree", function() {
  ...
  it("remove element", function() {
    ...
    expect(remove({value: 123, left: {value: 12}, right: {value: 234}}, 12)).toEqual({value: 123, left: null, right: {value: 234}});
    expect(remove({value: 123, left: {value: 12}, right: {value: 234}}, 234)).toEqual({value: 123, left: {value: 12}, right: null});
    expect(remove({value: 123, left: {value: 12}, right: {value: 234}}, 123)).toEqual({value: 234, left: {value: 12}, right: null});
